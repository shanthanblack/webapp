...
nmap --script smb-vuln-ms17-010.nse -p 80 13.232.120.152 --script-args=unsafe=1
nmap --script smb-vuln-ms17-010.nse -p 8080 13.232.120.152 --script-args=unsafe=1
